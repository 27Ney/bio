        ...
        7796: function(e, t, r) {
            ...
            function Z(e) {
                ...
                return console.error(u), console.error("A client-side exception has occurred, see here for more info: https://nextjs.org/docs/messages/client-side-exception-occurred"), i.loadPage("/_error").then(n => {
                    ...
                    return Promise.resolve((null == (i = e.props) ? void 0 : i.err) ? e.props : (0, w.loadGetInitialProps)(t, f)).then(t => es({ ...e,
                        err: u,
                        Component: l,
                        styleSheets: s,
                        props: t
                ...
                function(e, t, r) {
                    ...
                    if (!l || u || l.includes("__next_data_catchall") || l.includes("/_error") || l.includes("/404") || (u = l), u) {
                        ...
                        return Promise.resolve({
                            ...
                            destination: "" + (0, T.formatNextPathnameInfo)({ ...(0, w.getNextPathnameInfo)(t.pathname, {
                                    nextConfig: n,
                                    parseData: !0
                                }),
                    ...
                    if (s) {
                        if (s.startsWith("/")) {
                            let e = (0, v.parsePath)(s),
                                t = (0, T.formatNextPathnameInfo)({ ...(0, w.getNextPathnameInfo)(e.pathname, {
                                        nextConfig: n,
                                        parseData: !0
                                    }),
                                    defaultLocale: r.router.defaultLocale,
                ...
                async getRouteInfo(e) {
                    ...
                    try {
                        ...
                        if ((null == R ? void 0 : null == (P = R.effect) ? void 0 : P.type) === "rewrite") {
                            ...
                            if ((!h || o.includes(t)) && (g = t, r = R.effect.resolvedHref, n = { ...n,
                                    ...R.effect.parsedAs.query
                                }, i = (0, E.removeBasePath)((0, c.normalizeLocalePath)(R.effect.parsedAs.pathname, this.locales).pathname), e = this.components[g], u.shallow && e && this.route === g && !f)) return { ...e,
                                route: g
                            }
                        }
