...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [3495], {
        ...
        240: function(t, e, i) {
            ...
            let n = (0, i(7294).createContext)(null)
        },
        2074: function(t, e, i) {
            i.d(e, {
                Pn: function() {
        ...
        3495: function(t, e, i) {
            ...
            function ta(t, e, i) {
                for (let n in e) j(e[n]) || L(n, i) || (t[n] = e[n])
            }
            ...
            function tx(t, e, i, n) {
                for (let i in tv(t, e, void 0, n), e.attrs) t.setAttribute(ty.has(i) ? i : d(i), e.attrs[i])
            }
            ...
            function tP(t, e) {
                ...
                for (let r in i)(j(i[r]) || e.style && j(e.style[r]) || L(r, t)) && (n[r] = i[r]);
                return n
            }

            function tb(t, e) {
                let i = tP(t, e);
                for (let n in t)(j(t[n]) || j(e[n])) && (i[-1 !== k.indexOf(n) ? "attr" + n.charAt(0).toUpperCase() + n.substring(1) : n] = t[n]);
                return i
            }
                    ...
                    useVisualState: tC({
                        ...
                        onMount: (t, e, {
                            ...
                            tM.Wi.read(() => {
                                ...
                                }, tg(e.tagName), t.transformTemplate), tx(e, i)
                            })
                        }
                    })
                },
            ...
            function tz(t, e) {
                ...
                return tB(t.current, "pointer" + (e ? "enter" : "leave"), (n, r) => {
                    if ("touch" === n.pointerType || tH()) return;
                    let s = t.getProps();
                    t.animationState && s.whileHover && t.animationState.setActive("whileHover", e), s[i] && tM.Wi.update(() => s[i](n, r))
                }, {
            ...
            class t_ extends tZ {
                constructor() {
                    super(...arguments), this.removeStartListeners = tq.Z, this.removeEndListeners = tq.Z, this.removeAccessibleListeners = tq.Z, this.startPointerPress = (t, e) => {
                        ...
                        this.removeEndListeners = tU(n, r), this.startPress(t, e)
                    }, this.startAccessiblePress = () => {
                        let t = tR(this.node.current, "keydown", t => {
                                "Enter" !== t.key || this.isPressing || (this.removeEndListeners(), this.removeEndListeners = tR(this.node.current, "keyup", t => {
                ...
                startPress(t, e) {
                    ...
                    n && this.node.animationState && this.node.animationState.setActive("whileTap", !0), i && tM.Wi.update(() => i(t, e))
                }
                checkPressEnd() {
                    return this.removeEndListeners(), this.isPressing = !1, this.node.getProps().whileTap && this.node.animationState && this.node.animationState.setActive("whileTap", !1), !tH()
                }
                cancelPress(t, e) {
                    if (!this.checkPressEnd()) return;
                    let {
            ...
            let es = er(.42, 0, 1, 1),
                ...
                ey = t => {
                    if (Array.isArray(t)) {
                        (0, t4.k)(4 === t.length, "Cubic bezier arrays must contain four numerical values.");
                        let [e, i, n, r] = t;
                        return er(e, i, n, r)
                    }
                    return "string" == typeof t ? ((0, t4.k)(void 0 !== ev[t], `Invalid easing type '${t}'`), ev[t]) : t
                },
                ...
                eT = {
                    ...
                    transform: ({
                        ...
                        blue: i,
                        alpha: n = 1
                    }) => "rgba(" + ew.transform(t) + ", " + ew.transform(e) + ", " + ew.transform(i) + ", " + z(H.transform(n)) + ")"
                },
                eA = {
                    test: ex("#"),
                    parse: function(t) {
                ...
                eS = {
                    ...
                    transform: ({
                        ...
                        lightness: i,
                        alpha: n = 1
                    }) => "hsla(" + Math.round(t) + ", " + J.transform(z(e)) + ", " + J.transform(z(i)) + ", " + z(H.transform(n)) + ")"
                },
                eV = {
            ...
            function eR(t) {
                let e = ek(t);
                (0, t4.k)(!!e, `'${t}' is not an animatable color. Use the equivalent color code instead.`);
                let i = e.parse(t);
            ...
            let eL = (t, e) => {
                    ...
                    return t => (r.red = eM(i.red, n.red, t), r.green = eM(i.green, n.green, t), r.blue = eM(i.blue, n.blue, t), r.alpha = eE(i.alpha, n.alpha, t), eT.transform(r))
                },
                ej = {
            ...
            let ez = (t, e) => {
                ...
                eY = (t, e) => {
                    let i = { ...t,
                        ...
                        n = {};
                    for (let r in i) void 0 !== t[r] && void 0 !== e[r] && (n[r] = eZ(t[r], e[r]));
                    return t => {
                ...
                eX = (t, e) => {
                    let i = e$.createTransformer(e),
                        n = eU(t),
                        r = eU(e);
                    return n.numVars === r.numVars && n.numColors === r.numColors && n.numNumbers >= r.numNumbers ? tU(ez(n.values, r.values), i) : ((0, t4.K)(!0, `Complex values '${t}' and '${e}' too different to mix. Ensure all colors are of the same type, and that each contains the same quantity of number and color values. Falling back to instant transition.`), eH(t, e))
                },
                eG = (t, e, i) => {
                    let n = e - t;
                    return 0 === n ? 1 : (i - t) / n
            ...
            function eK(t, e, {
                ...
                let s = t.length;
                if ((0, t4.k)(s === e.length, "Both input and output ranges must be the same length"), 1 === s) return () => e[0];
                ...
                let o = function(t, e, i) {
                        ...
                        for (let i = 0; i < s; i++) {
                            let s = r(t[i], t[i + 1]);
                            e && (s = tU(Array.isArray(e) ? e[i] || tq.Z : e, s)), n.push(s)
                        }
                        return n
                    }(e, n, r),
                    a = o.length,
                    ...
                    },
                    {
                        ...
                        if (!e5(t, e1) && e5(t, e0)) {
                            let i = function({
                                ...
                                let r, s;
                                (0, t4.K)(t <= t9(10), "Spring duration must be 10 seconds or less");
                                let o = 1 - e;
                                o = N(.05, 1, o), t = N(.01, 10, t8(t)), o < 1 ? (r = e => {
                                    let n = e * o,
                                        r = n * t;
            ...
            function e8({
                ...
                let D = 0,
                    k = t => {
                        if (null === S) return;
                        y > 0 && (S = Math.min(S, t)), y < 0 && (S = Math.min(t - M / y, S));
                        ...
                        if (s) {
                            let t = Math.min(D, M) / C,
                                e = Math.floor(t),
                                i = t % 1;
                            !i && t >= 1 && (i = 1), 1 === i && e--, (e = Math.min(e, s + 1)) % 2 && ("reverse" === a ? (i = 1 - i, o && (i -= o / C)) : "mirror" === a && (u = v)), l = N(0, 1, i) * C
                        }
                        let h = r ? {
                            done: !1,
                            value: n[0]
                ...
                let B = {
                    ...
                    set time(newTime) {
                        D = newTime = t9(newTime), null === A && f && 0 !== y ? S = f.now() - newTime / y : A = newTime
                    },
                    get duration() {
            ...
            let ix = {
                ...
                iP = (t, e, i, n = {}) => r => {
                    ...
                    let l = function(t, e, i, n) {
                            ...
                            if (o && l.length && s)
                                for (let t = 0; t < l.length; t++) r[l[t]] = ig(e, s);
                            return r
                        }(e, t, i, s),
                        u = l[0],
                        h = l[l.length - 1],
                        c = il(t, u),
                        d = il(t, h);
                    (0, t4.K)(c === d, `You are trying to animate ${t} from "${u}" to "${h}". ${u} is not an animatable value - to enable this animation set ${u} to a value animatable to ${h} via the \`style\` property.`);
                    let p = {
                        keyframes: l,
                    ...
                    if (! function({
                            ...
                            ...ia(t, p)
                        }), p.duration && (p.duration = t9(p.duration)), p.repeatDelay && (p.repeatDelay = t9(p.repeatDelay)), !c || !d || t7.current || !1 === s.type || ix.skipAnimations) return function({
                        keyframes: t,
                        delay: e,
                        onUpdate: i,
                        onComplete: n
                    ...
                    if (!n.isHandoff && e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate) {
                        let i = function(t, e, {
                            ...
                            let s, o;
                            if (!(e7() && it.has(e) && !r.repeatDelay && "mirror" !== r.repeatType && 0 !== r.damping && "inertia" !== r.type)) return !1;
                            let a = !1,
                                l = !1,
                                u = () => {
                                    o = new Promise(t => {
                            ...
                            return m.onfinish = () => {
                                ...
                                then: (t, e) => o.then(t, e),
                                attachTimeline: t => (m.timeline = t, m.onfinish = null, tq.Z),
                                get time() {
            ...
            class iC {
                constructor(t, e = {}) {
                    ...
                    }, this.scheduleVelocityCheck = () => tM.Wi.postRender(this.velocityCheck), this.velocityCheck = ({
                        timestamp: t
                    }) => {
                ...
                getVelocity() {
                    var t, e;
                    return this.canTrackVelocity ? (t = parseFloat(this.current) - parseFloat(this.prev), (e = this.timeDelta) ? 1e3 / e * t : 0) : 0
                }
                start(t) {
            ...
            function iF(t, e, {
                ...
                for (let e in a) {
                    ...
                    let d = n.animation;
                    ib(l) && (l.add(e), d.then(() => l.remove(e))), u.push(d)
                }
                    ...
                    o = t.variantChildren && t.variantChildren.size ? (n = 0) => {
                        ...
                        return function(t, e, i = 0, n = 0, r = 1, s) {
                            ...
                            return Array.from(t.variantChildren).sort(iO).forEach((t, n) => {
                                t.notify("AnimationStart", e), o.push(iB(t, e, { ...s,
                                    delay: i + l(n)
                ...
                constructor(t) {
                    super(t), t.animationState || (t.animationState = function(t) {
                        let e = e => Promise.all(e.map(({
                                ...
                                let n;
                                if (t.notify("AnimationStart", e), Array.isArray(e)) n = Promise.all(e.map(e => iB(t, e, i)));
                                else if ("string" == typeof e) n = iB(t, e, i);
                                else {
                        ...
                        function s(s, o) {
                            ...
                            for (let e = 0; e < iW; e++) {
                                ...
                                if (b && n && t.manuallyAnimateOnMount && (b = !1), v.protectedKeys = { ...c
                                    }, !v.isActive && null === P || !y && !v.prevProp || g(y) || "boolean" == typeof y) continue;
                                let w = (p = v.prevProp, ("string" == typeof y ? y !== p : !!Array.isArray(y) && !t3(y, p)) || m === o && v.isActive && !b && x || e > d && x),
                                    T = !1,
                                ...
                                let {
                                    ...
                                    w = !0, h.has(t) && (T = !0, h.delete(t)), v.needsAnimating[t] = !0
                                };
                                for (let t in E) {
                                    let e = S[t],
                                        i = V[t];
                                    if (!c.hasOwnProperty(t))(tA(e) && tA(i) ? t3(e, i) : e === i) ? void 0 !== e && h.has(t) ? C(t) : v.protectedKeys[t] = !0 : void 0 !== e ? C(t) : h.add(t)
                                }
                                v.prevProp = y, v.prevResolvedValues = S, v.isActive && (c = { ...c,
                                    ...S
                                }), n && t.blockInitialAnimation && (w = !1), w && (!b || T) && u.push(...A.map(t => ({
                                    animation: t,
                                    options: {
                                        type: m,
                                        ...s
            ...
            class iz {
                constructor(t, e, {
                    ...
                    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.contextWindow = window, this.updatePoint = () => {
                            ...
                            this.lastMoveEvent = t, this.lastMoveEventInfo = iY(e, this.transformPagePoint), tM.Wi.update(this.updatePoint, !0)
                    ...
                    l && l(t, iG(s, this.history)), this.removeListeners = tU(tB(this.contextWindow, "pointermove", this.handlePointerMove), tB(this.contextWindow, "pointerup", this.handlePointerUp), tB(this.contextWindow, "pointercancel", this.handlePointerUp))
                }
                updateHandlers(t) {
                    this.handlers = t
                }
                end() {
                    this.removeListeners && this.removeListeners(), (0, tM.Pn)(this.updatePoint)
                }
            }
                ...
                return {
                    ...
                    velocity: function(t, e) {
                        ...
                        let i = t.length - 1,
                            n = null,
                            r = iq(t);
                        for (; i >= 0 && (n = t[i], !(r.timestamp - n.timestamp > t9(.1)));) i--;
                        if (!n) return {
                            x: 0,
                            y: 0
                        };
            ...
            function iJ(t, e, i, n = .5) {
                t.origin = n, t.originPoint = eE(e.min, e.max, t.origin), t.scale = iK(i) / iK(e), (i_(t.scale, 1, 1e-4) || isNaN(t.scale)) && (t.scale = 1), t.translate = eE(i.min, i.max, t.origin) - t.originPoint, (i_(t.translate) || isNaN(t.translate)) && (t.translate = 0)
            }
            ...
            function nl(t, e = 0, i = 1, n, r) {
                t.min = na(t.min, e, i, n, r), t.max = na(t.max, e, i, n, r)
            }
            ...
            function nu(t, {
                ...
                nl(t.x, e.translate, e.scale, e.originPoint), nl(t.y, i.translate, i.scale, i.originPoint)
            }
            ...
            class nx {
                constructor(t) {
                    this.openGlobalLock = null, this.isDragging = !1, this.currentDirection = null, this.originPoint = {
                        x: 0,
                        y: 0
                    }, this.constraints = !1, this.hasMutatedConstraints = !1, this.elastic = nt(), this.visualElement = t
                }
                start(t, {
                    snapToCursor: e = !1
                } = {}) {
                    ...
                    this.panSession = new iz(t, {
                        onSessionStart: t => {
                            ...
                            i ? this.pauseAnimation() : this.stopAnimation(), e && this.snapToCursor(tj(t, "page").point)
                        },
                        onStart: (t, e) => {
                            let {
                                drag: i,
                            ...
                            this.isDragging = !0, this.currentDirection = null, this.resolveConstraints(), this.visualElement.projection && (this.visualElement.projection.isAnimationBlocked = !0, this.visualElement.projection.target = void 0), ne(t => {
                ...
                updateAxis(t, e, i) {
                    ...
                    if (!i || !nP(t, n, this.currentDirection)) return;
                ...
                resolveConstraints() {
                    ...
                    }(i), r !== this.constraints && n && this.constraints && !this.hasMutatedConstraints && ne(t => {
                ...
                resolveRefConstraints() {
                    ...
                    if (!e || !m(e)) return !1;
                    let n = e.current;
                    (0, t4.k)(null !== n, "If `dragConstraints` is set as a React ref, that ref must be passed to another component's `ref` prop.");
                    let {
                        projection: r
                    } = this.visualElement;
                    ...
                    let s = function(t, e, i) {
                            ...
                            return r && (nc(n.x, r.offset.x), nc(n.y, r.offset.y)), n
                ...
                snapToCursor(t) {
                    ne(e => {
                        ...
                        if (!nP(e, i, this.currentDirection)) return;
                        let {
                            projection: n
                ...
                scalePositionWithinConstraints() {
                        ...
                        if (e) {
                            ...
                            n[t] = function(t, e) {
                                let i = .5,
                                    n = iK(t),
                                    r = iK(e);
                                return r > n ? i = eG(e.min, e.max - n, t.min) : n > r && (i = eG(t.min, t.max - r, e.min)), N(0, 1, i)
                            }({
                                min: i,
                                max: i
                            }, this.constraints[t])
                    ...
                    this.visualElement.current.style.transform = r ? r({}, "") : "none", i.root && i.root.updateScroll(), i.updateLayout(), this.resolveConstraints(), ne(e => {
            ...
            class nb extends tZ {
                constructor(t) {
                    super(t), this.removeGroupControls = tq.Z, this.removeListeners = tq.Z, this.controls = new nx(t)
                }
                mount() {
                    let {
                        dragControls: t
                    } = this.node.getProps();
                    t && (this.removeGroupControls = t.subscribe(this.controls)), this.removeListeners = this.controls.addListeners() || tq.Z
                }
                unmount() {
            ...
            class nT extends tZ {
                ...
                createPanHandlers() {
                    ...
                    return {
                        ...
                        onMove: i,
                        onEnd: (t, e) => {
                            delete this.session, n && tM.Wi.update(() => n(t, e))
                        }
                    }
                }
                mount() {
            ...
            class nE extends o.Component {
                componentDidMount() {
                    ...
                    Object.assign(D, nM), r && (e.group && e.group.add(r), i && i.register && n && i.register(r), r.root.didUpdate(), r.addEventListener("animationComplete", () => {
                        this.safeToRemove()
                ...
                getSnapshotBeforeUpdate(t) {
                    ...
                    return s && (s.isPresent = r, n || t.layoutDependency !== e || void 0 === e ? s.willUpdate() : this.safeToRemove(), t.isPresent === r || (r ? s.promote() : s.relegate() || tM.Wi.postRender(() => {
                        let t = s.getStack();
            ...
            function nC(t) {
                ...
                }(), n = (0, o.useContext)(S.p);
                return o.createElement(nE, { ...t,
                    layoutGroup: n,
            ...
            function nN(t, e, [i, n, r], s, o) {
                ! function(t, e = 0, i = 1, n = .5, r, s = t, o = t) {
                    if (J.test(e) && (e = parseFloat(e), e = eE(o.min, o.max, e / 100) - o.min), "number" != typeof e) return;
                    let a = eE(s.min, s.max, n);
                    t === s && (a -= e), t.min = nI(t.min, e, i, a, r), t.max = nI(t.max, e, i, a, r)
            ...
            function nZ(t, e, i, n) {
                nN(t.x, e, n$, i ? i.x : void 0, n ? n.x : void 0), nN(t.y, e, nH, i ? i.y : void 0, n ? n.y : void 0)
            }
                ...
                return class {
                    constructor(t = {}, i = null == e ? void 0 : e()) {
                        this.id = n1++, this.animationId = 0, this.children = new Set, this.options = {}, this.isTreeAnimating = !1, this.isAnimationBlocked = !1, this.isLayoutDirty = !1, this.isProjectionDirty = !1, this.isSharedProjectionDirty = !1, this.isTransformDirty = !1, this.updateManuallyBlocked = !1, this.updateBlockedByResize = !1, this.isUpdating = !1, this.isSVG = !1, this.needsReset = !1, this.shouldResetTransform = !1, this.treeScale = {
                            ...
                            this.projectionUpdateScheduled = !1, n5.totalNodes = n5.resolvedTargetDeltas = n5.recalculatedProjection = 0, this.nodes.forEach(n4), this.nodes.forEach(rn), this.nodes.forEach(rr), this.nodes.forEach(n9), window.MotionDebug && window.MotionDebug.record(n5)
                    ...
                    mount(e, i = this.root.hasTreeAnimated) {
                        ...
                        if (s && !s.current && s.mount(e), this.root.nodes.add(this), this.parent && this.parent.children.add(this), i && (r || n) && (this.isLayoutDirty = !0), t) {
                            ...
                            t(e, () => {
                                ...
                                }(n, 0), nA.hasAnimatedSinceResize && (nA.hasAnimatedSinceResize = !1, this.nodes.forEach(ri))
                            })
                        }
                    ...
                    unmount() {
                        ...
                        let t = this.getStack();
                        t && t.remove(this), this.parent && this.parent.children.delete(this), this.instance = void 0, (0, tM.Pn)(this.updateProjection)
                    }
                    blockUpdate() {
                    ...
                    update() {
                        ...
                        this.isUpdating || this.nodes.forEach(rt), this.isUpdating = !1, this.nodes.forEach(re), this.nodes.forEach(n3), this.nodes.forEach(n6), this.clearAllSnapshots();
                        let t = performance.now();
                        tM.frameData.delta = N(0, 1e3 / 60, t - tM.frameData.timestamp), tM.frameData.timestamp = t, tM.frameData.isProcessing = !0, tM.S6.update.process(tM.frameData), tM.S6.preRender.process(tM.frameData), tM.S6.render.process(tM.frameData), tM.frameData.isProcessing = !1
                    }
                    didUpdate() {
                        this.updateScheduled || (this.updateScheduled = !0, queueMicrotask(() => this.update()))
                    }
                    clearAllSnapshots() {
                        this.nodes.forEach(n8), this.sharedNodes.forEach(ro)
                    }
                    scheduleUpdateProjection() {
                        this.projectionUpdateScheduled || (this.projectionUpdateScheduled = !0, tM.Wi.preRender(this.updateProjection, !1, !0))
                    }
                    ...
                    resetTransform() {
                        ...
                        t && (e || ns(this.latestValues) || s) && (r(this.instance, n), this.shouldResetTransform = !1, this.scheduleRender())
                    }
                    measure(t = !0) {
                        var e;
                    ...
                    measurePageBox() {
                        ...
                        return i && (nc(e.x, i.offset.x), nc(e.y, i.offset.y)), e
                    }
                        ...
                        for (let i = 0; i < this.path.length; i++) {
                            ...
                            if (n !== this.root && r && s.layoutScroll) {
                                if (r.isRoot) {
                                    ...
                                    i && (nc(e.x, -i.offset.x), nc(e.y, -i.offset.y))
                                }
                                nc(e.x, r.offset.x), nc(e.y, r.offset.y)
                            }
                        }
                        return e
                    }
                    applyTransform(t, e = !1) {
                        ...
                        return ns(this.latestValues) && nf(i, this.latestValues), i
                    }
                    removeTransform(t) {
                        let e = nt();
                        nW(e, t);
                        for (let t = 0; t < this.path.length; t++) {
                            let i = this.path[t];
                            if (!i.instance || !ns(i.latestValues)) continue;
                            nr(i.latestValues) && i.updateSnapshot();
                            let n = nt();
                            nW(n, i.measurePageBox()), nZ(e, i.latestValues, i.snapshot ? i.snapshot.layoutBox : void 0, n)
                        }
                        return ns(this.latestValues) && nZ(e, this.latestValues), e
                    }
                    setTargetDelta(t) {
                    ...
                    resolveTargetDelta(t = !1) {
                        ...
                        if (this.layout && (a || l)) {
                            if (this.resolvedRelativeTargetAt = tM.frameData.timestamp, !this.targetDelta && !this.relativeTarget) {
                                let t = this.getClosestProjectingParent();
                                t && t.layout && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = nt(), this.relativeTargetOrigin = nt(), i5(this.relativeTargetOrigin, this.layout.layoutBox, t.layout.layoutBox), nW(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                            }
                            if (this.relativeTarget || this.targetDelta) {
                                if ((this.target || (this.target = nt(), this.targetWithTransforms = nt()), this.relativeTarget && this.relativeTargetOrigin && this.relativeParent && this.relativeParent.target) ? (this.forceRelativeParentToResolveTarget(), i = this.target, n = this.relativeTarget, r = this.relativeParent.target, i0(i.x, n.x, r.x), i0(i.y, n.y, r.y)) : this.targetDelta ? (this.resumingFrom ? this.target = this.applyTransform(this.layout.layoutBox) : nW(this.target, this.layout.layoutBox), nu(this.target, this.targetDelta)) : nW(this.target, this.layout.layoutBox), this.attemptToResolveRelativeTarget) {
                                    this.attemptToResolveRelativeTarget = !1;
                                    let t = this.getClosestProjectingParent();
                                    t && !!t.resumingFrom == !!this.resumingFrom && !t.options.layoutScroll && t.target && 1 !== this.animationProgress ? (this.relativeParent = t, this.forceRelativeParentToResolveTarget(), this.relativeTarget = nt(), this.relativeTargetOrigin = nt(), i5(this.relativeTargetOrigin, this.target, t.target), nW(this.relativeTarget, this.relativeTargetOrigin)) : this.relativeParent = this.relativeTarget = void 0
                                }
                    ...
                    calcProjection() {
                        ...
                        let e = this.getLead(),
                            ...
                            n = !0;
                        if ((this.isProjectionDirty || (null === (t = this.parent) || void 0 === t ? void 0 : t.isProjectionDirty)) && (n = !1), i && (this.isSharedProjectionDirty || this.isTransformDirty) && (n = !1), this.resolvedRelativeTargetAt === tM.frameData.timestamp && (n = !1), n) return;
                        let {
                            layout: r,
                            layoutId: s
                        } = this.options;
                            ...
                            if (o) {
                                ...
                                for (let a = 0; a < o; a++) {
                                    ...
                                    (!o || !o.style || "contents" !== o.style.display) && (n && r.options.layoutScroll && r.scroll && r !== r.root && nf(t, {
                                        x: -r.scroll.offset.x,
                                        y: -r.scroll.offset.y
                                    }), s && (e.x *= s.x.scale, e.y *= s.y.scale, nu(t, s)), n && ns(r.latestValues) && nf(t, r.latestValues))
                                }
                                e.x = nh(e.x), e.y = nh(e.y)
                            }
                        ...
                        if (!l) {
                            this.projectionTransform && (this.projectionDelta = i8(), this.projectionTransform = "none", this.scheduleRender());
                            return
                        }
                        this.projectionDelta || (this.projectionDelta = i8(), this.projectionDeltaWithTransform = i8());
                        let u = this.projectionTransform;
                        iQ(this.projectionDelta, this.layoutCorrected, l, this.latestValues), this.projectionTransform = nK(this.projectionDelta, this.treeScale), (this.projectionTransform !== u || this.treeScale.x !== o || this.treeScale.y !== a) && (this.hasProjected = !0, this.scheduleRender(), this.notifyListeners("projectionUpdate", l)), n5.recalculatedProjection++
                    }
                    hide() {
                        this.isVisible = !1
                    }
                    ...
                    setAnimationOrigin(t, e = !1) {
                        ...
                        this.animationProgress = 0, this.mixTargetDelta = e => {
                            ...
                            if (ra(o.x, t.x, n), ra(o.y, t.y, n), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout) {
                                var u, d, p, m;
                                i5(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox), p = this.relativeTarget, m = this.relativeTargetOrigin, rl(p.x, m.x, a.x, n), rl(p.y, m.y, a.y, n), i && (u = this.relativeTarget, d = i, u.x.min === d.x.min && u.x.max === d.x.max && u.y.min === d.y.min && u.y.max === d.y.max) && (this.isProjectionDirty = !1), i || (i = nt()), nW(i, this.relativeTarget)
                            }
                            l && (this.animationValues = s, function(t, e, i, n, r, s) {
                                r ? (t.opacity = eE(0, void 0 !== i.opacity ? i.opacity : 1, nF(n)), t.opacityExit = eE(void 0 !== e.opacity ? e.opacity : 1, 0, nB(n))) : s && (t.opacity = eE(void 0 !== e.opacity ? e.opacity : 1, void 0 !== i.opacity ? i.opacity : 1, n));
                                for (let r = 0; r < nk; r++) {
                                    let s = `border${nD[r]}Radius`,
                                        o = nj(e, s),
                                        a = nj(i, s);
                                    (void 0 !== o || void 0 !== a) && (o || (o = 0), a || (a = 0), 0 === o || 0 === a || nL(o) === nL(a) ? (t[s] = Math.max(eE(nR(o), nR(a), n), 0), (J.test(a) || J.test(o)) && (t[s] += "%")) : t[s] = a)
                    ...
                    startAnimation(t) {
                        this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && ((0, tM.Pn)(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = tM.Wi.update(() => {
                            nA.hasAnimatedSinceResize = !0, this.currentAnimation = function(t, e, i) {
                                let n = j(0) ? 0 : iM(0);
                                return n.start(iP("", n, 1e3, i)), n.animation
                            }(0, 0, { ...t,
                                onUpdate: e => {
                    ...
                    applyTransformsToTarget() {
                        ...
                        if (e && i && n) {
                            ...
                            nW(e, i), nf(e, r), iQ(this.projectionDeltaWithTransform, this.layoutCorrected, e, r)
                        }
                    }
                    registerSharedNode(t, e) {
                        this.sharedNodes.has(t) || this.sharedNodes.set(t, new nq), this.sharedNodes.get(t).add(e);
                    ...
                    getProjectionStyles(t) {
                        ...
                        if (this.needsReset) return this.needsReset = !1, n.opacity = "", n.pointerEvents = tE(null == t ? void 0 : t.pointerEvents) || "", n.transform = r ? r(this.latestValues, "") : "none", n;
                        let s = this.getLead();
                        if (!this.projectionDelta || !this.layout || !s.target) {
                            let e = {};
                            return this.options.layoutId && (e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1, e.pointerEvents = tE(null == t ? void 0 : t.pointerEvents) || ""), this.hasProjected && !ns(this.latestValues) && (e.transform = r ? r({}, "") : "none", this.hasProjected = !1), e
                        }
                        let o = s.animationValues || s.latestValues;
                        this.applyTransformsToTarget(), n.transform = nK(this.projectionDeltaWithTransform, this.treeScale, o), r && (n.transform = r(o, n.transform));
                        let {
                            x: a,
                            y: l
                        } = this.projectionDelta;
                        for (let t in n.transformOrigin = `${100*a.origin}% ${100*l.origin}% 0`, s.animationValues ? n.opacity = s === this ? null !== (i = null !== (e = o.opacity) && void 0 !== e ? e : this.latestValues.opacity) && void 0 !== i ? i : 1 : this.preserveOpacity ? this.latestValues.opacity : o.opacityExit : n.opacity = s === this ? void 0 !== o.opacity ? o.opacity : "" : void 0 !== o.opacityExit ? o.opacityExit : 0, D) {
                            if (void 0 === o[t]) continue;
                            let {
                                correct: e,
                                applyTo: i
                            } = D[t], r = "none" === n.transform ? o[t] : e(o[t], s);
                            if (i) {
                                let t = i.length;
                                for (let e = 0; e < t; e++) n[i[e]] = r
                            } else n[t] = r
                        }
                        return this.options.layoutId && (n.pointerEvents = s === this ? tE(null == t ? void 0 : t.pointerEvents) || "" : "none"), n
                    }
                    clearSnapshot() {
                    ...
                    if (!t.resumeFrom) {
                        ...
                        if (n && !n.resumeFrom) {
                            ...
                            if (r && s) {
                                ...
                                let a = nt();
                                i5(a, e, s.layoutBox), nX(o, a) || (u = !0), n.options.layoutRoot && (t.relativeTarget = a, t.relativeTargetOrigin = o, t.relativeParent = n)
                            }
                        }
                    }
            ...
            function n4(t) {
                n5.totalNodes++, t.parent && (t.isProjecting() || (t.isProjectionDirty = t.parent.isProjectionDirty), t.isSharedProjectionDirty || (t.isSharedProjectionDirty = !!(t.isProjectionDirty || t.parent.isProjectionDirty || t.parent.isSharedProjectionDirty)), t.isTransformDirty || (t.isTransformDirty = t.parent.isTransformDirty))
            }
            ...
            function rx(t, e, i = 1) {
                (0, t4.k)(i <= 4, `Max CSS variable fallback depth detected in property "${t}". This may indicate a circular fallback dependency.`);
                let [n, r] = function(t) {
                    let e = ry.exec(t);
                    if (!e) return [, ];
                    let [, i, n] = e;
            ...
            rC.translateX = rC.x, rC.translateY = rC.y;
            let rM = (t, e, i) => {
                    ...
                    if (r.forEach(r => {
                            ...
                            if (tA(d)) {
                                let t = d.length,
                                    e = null === d[0] ? 1 : 0;
                                c = iR(h = d[e]);
                                for (let i = e; i < t && null !== d[i]; i++) l ? (0, t4.k)(iR(d[i]) === l, "All keyframes must be of the same type") : (l = iR(d[i]), (0, t4.k)(l === c || rT(c) && rT(l), "Keyframes must be of the same dimension as the current value"))
                            } else l = iR(d);
                            if (c !== l) {
                                if (rT(c) && rT(l)) {
                                    let t = u.get();
                                    "string" == typeof t && u.set(parseFloat(t)), "string" == typeof d ? e[r] = parseFloat(d) : Array.isArray(d) && l === Q && (e[r] = d.map(parseFloat))
                        ...
                        return s.length && s.forEach(([e, i]) => {
                            t.getValue(e).set(i)
                        }), t.render(), A.j && null !== i && window.scrollTo({
                            top: i
                        }), {
                            target: r,
                            transitionEnd: n
                ...
                rk = (t, e, i, n) => {
                    ...
                    return e = o.target, n = o.transitionEnd, r = e, s = n, rw(r) ? rD(t, r, i, s) : {
                        target: r,
                        transitionEnd: s
                    }
                },
            ...
            class rW {
                constructor({
                    ...
                    } : {}, this.renderState = a, this.parent = t, this.props = e, this.presenceContext = i, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = n, this.options = s, this.isControllingVariants = x(e), this.isVariantNode = P(e), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(t && t.current);
                    let {
                        willChange: l,
                        ...u
                    ...
                    for (let t in u) {
                        let e = u[t];
                        void 0 !== o[t] && j(e) && (e.set(o[t], !1), ib(l) && l.add(t))
                    }
                }
                ...
                mount(t) {
                    this.current = t, rj.set(t, this), this.projection && !this.projection.instance && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((t, e) => this.bindToMotionValue(e, t)), rL.current || function() {
                        if (rL.current = !0, A.j) {
                    ...
                    }(), this.shouldReduceMotion = "never" !== this.reducedMotionConfig && ("always" === this.reducedMotionConfig || rR.current), this.parent && this.parent.children.add(this), this.update(this.props, this.presenceContext)
                }
                unmount() {
                    for (let t in rj.delete(this.current), this.projection && this.projection.unmount(), (0, tM.Pn)(this.notifyUpdate), (0, tM.Pn)(this.render), this.valueSubscriptions.forEach(t => t()), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this), this.events) this.events[t].clear();
                ...
                bindToMotionValue(t, e) {
                    let i = R.has(t),
                        n = e.on("change", e => {
                            this.latestValues[t] = e, this.props.onUpdate && tM.Wi.update(this.notifyUpdate, !1, !0), i && this.projection && (this.projection.isTransformDirty = !0)
                        }),
                ...
                update(t, e) {
                    ...
                    this.prevMotionValues = function(t, e, i) {
                        ...
                        for (let r in e) {
                            let s = e[r],
                                o = i[r];
                            if (j(s)) t.addValue(r, s), ib(n) && n.add(r);
                            else if (j(o)) t.addValue(r, iM(s, {
                                owner: t
                            })), ib(n) && n.remove(r);
                            else if (o !== s) {
                                if (t.hasValue(r)) {
                ...
                getBaseTarget(t) {
                    ...
                    let {
                        initial: i
                    } = this.props, n = "string" == typeof i || "object" == typeof i ? null === (e = tw(this.props, i)) || void 0 === e ? void 0 : e[t] : void 0;
                            ...
                            if (o)
                                for (let a = 0; a < o; a++) {
                                    let o = s[a],
                                        l = e[o],
                                        u = null;
                                    Array.isArray(l) && (u = l[0]), null === u && (u = null !== (r = null !== (n = i[o]) && void 0 !== n ? n : t.readValue(o)) && void 0 !== r ? r : e[o]), null != u && ("string" == typeof u && (iw(u) || iv(u)) ? u = parseFloat(u) : !ij(u) && e$.test(l) && (u = ig(o, l)), t.addValue(o, iM(u, {
                                        owner: t
            ...
            class r$ extends rI {
                ...
                readValueFromInstance(t, e) {
                    ...
                    return e = ty.has(e) ? e : d(e), t.getAttribute(e)
                }
                            ...
                            let s = (0, o.forwardRef)(function(s, d) {
                                ...
                                if (!P && A.j) {
                                    w.visualElement = function(t, e, i, n) {
                                        let {
                                            visualElement: r
                                        } = (0, o.useContext)(l), s = (0, o.useContext)(c), d = (0, o.useContext)(u.O), m = (0, o.useContext)(a).reducedMotion, f = (0, o.useRef)();
                                        ...
                                        let v = (0, o.useRef)(!!(i[p] && !window.HandoffComplete));
                                        return (0, h.L)(() => {
                                ...
                                return o.createElement(l.Provider, {
                                    ...
                                    ...y
                                }) : null, i(r, s, (g = w.visualElement, (0, o.useCallback)(t => {
                                    t && T.mount && T.mount(t), g && (t ? g.mount(t) : g.unmount()), d && ("function" == typeof d ? d(t) : m(d) && (d.current = t))
                            ...
                            return (e, i, n, {
                                ...
                                let a = (M(e) ? function(t, e, i, n) {
                                        let r = (0, o.useMemo)(() => {
                                            ...
                                            return tm(i, e, {
                                                enableHardwareAcceleration: !1
                                            }, tg(n), t.transformTemplate), { ...i.attrs,
                                                style: { ...i.style
                                                }
                                            }
                                        }, [e]);
                                        ...
                                        let n = {},
                                            r = function(t, e, i) {
                                                let n = t.style || {},
                                                    r = {};
                                                return ta(r, n, t), Object.assign(r, function({
                                                    transformTemplate: t
                                                }, e, i) {
                                                    return (0, o.useMemo)(() => {
                                                        let n = to();
                                    ...
                                    l = { ... function(t, e, i) {
                                            let n = {};
                                            for (let r in t)("values" !== r || "object" != typeof t.values) && (th(r) || !0 === i && tu(r) || !e && !tu(r) || t.draggable && r.startsWith("onDrag")) && (n[r] = t[r]);
                                            return n
                                        }(i, "string" == typeof e, t),
                                        ...a,
                                        ref: n
                                    ...
                                    h = (0, o.useMemo)(() => j(u) ? u.get() : u, [u]);
                                return (0, o.createElement)(e, { ...l,
                                    children: h
                                })
                            }
                        }(e),
